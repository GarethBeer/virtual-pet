...
describe('Create a new object with defined properties', () => {
    ...
    test('initial fitness value set to 0', () => {   expect(pet.fitness).toBe(10);
    })
    test('initial hunger value set to 0', () => {   expect(pet.hunger).toBe(0);
    })
});
...
describe('Testing prototype methods on the object', () => {
    ...
    test('growUp method increments age by 1', () => { expect(pet.age).toBe(0);
         pet.growUp();
    ...
    test('returns message to let us know pet is hungry', () => { 
     ...
     test('returns a message if it is not tired and not hungry', () => { pet.fitness = 4
          pet.hunger = 0
         expect(pet.checkUp()).toStrictEqual('I feel great!')
     })
     test('returns a message if it is tired and hungry', () => {       pet.fitness = 3
        pet.hunger = 5
